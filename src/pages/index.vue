  ...
  <div class="flex flex-col grow justify-evenly px-2">
    <div class="flex flex-col p-2 mb-3">
      <div class="mx-auto">
        <br>
        <VSelect
          class="style-chooser w-fit min-w-100 mx-auto"
        ...
        <div class="flex justify-center mt-2 gap-5">
          ...
          <Popper hover>
            ...
            <template #content>
              Can't find your university in the university selection dropdown?
              <br>
          ...
          <Popper hover>
            <span class="text-sm underline cursor-help">How do I search?</span>
            <template #content>
              You must add a department name and course number.
              <br>
              You can attach a section number, semester, year, and professor.
              <br>
              EX: "CSCE 121 Fall 2022" or "CSCE 121.509 2022 Doe".
            </template>
          </Popper>
        </div>
      </div>
